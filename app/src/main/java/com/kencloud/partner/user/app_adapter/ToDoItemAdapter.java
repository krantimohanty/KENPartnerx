...
/**
 * Adapter to bind a Ken_MobileApp List to a view
 */
public class ToDoItemAdapter extends ArrayAdapter<Ken_MobileApp> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Ken_MobileApp currentItem = getItem(position);
