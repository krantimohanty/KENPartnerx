...
public class InMemoryCacheStore extends TokenCache implements ITokenCacheStore {
    ...
    private static final com.microsoft.aad.taskapplication.helpers.InMemoryCacheStore INSTANCE = new com.microsoft.aad.taskapplication.helpers.InMemoryCacheStore();

    private InMemoryCacheStore() {}

    public static com.microsoft.aad.taskapplication.helpers.InMemoryCacheStore getInstance() {
        return INSTANCE;
    }
